...
locals {
  ...
  app_insights_id                  = data.terraform_remote_state.monitor.outputs.app_insights_id
  app_insights_instrumentation_key = data.terraform_remote_state.monitor.outputs.instrumentation_key
}
...
module "apim" {
  ...
  app_insights_instrumentation_key = local.app_insights_instrumentation_key

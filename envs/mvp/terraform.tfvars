# =============================================================================
# PROJECT CONTROL SHEET — MVP Environment
# =============================================================================
# MVP mirrors dev infrastructure (same SKUs, scale settings, feature flags).
# It is a completely separate deployment with its own resource groups, state,
# and data — intended as an isolated environment for testing or early product
# delivery, separate from the dev platform.
# =============================================================================
...
# -----------------------------------------------------------------------------
# ACCESS CONTROL
# enable_private_endpoints = false → resources have public endpoints (mvp default)
...
# PostgreSQL firewall — open to all in mvp since private endpoints are disabled.
...
# DATABASES
# -----------------------------------------------------------------------------
postgresql_sku        = "B_Standard_B1ms"  # Small for mvp — scale up if needed
...
container_apps = [
  {
    ...
    cpu               = 0.5
    memory            = "1Gi"
    min_replicas      = 0      # Scales to zero when idle (saves cost in mvp)
    max_replicas      = 2
    target_port       = 8000
...
sku_name        = "Consumption_0"         # Consumption = per-call pricing, no fixed cost in mvp
